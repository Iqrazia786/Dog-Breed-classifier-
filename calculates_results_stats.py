...
def calculates_results_stats(results_dic):
   ...
   # print(results_stats_dic)
    ...
    ################################################################
    ######## formula is correct still zero division error is occuring for results_stats_dic['n_dogs_img']
    ########### need to be checked again #### check again #####
